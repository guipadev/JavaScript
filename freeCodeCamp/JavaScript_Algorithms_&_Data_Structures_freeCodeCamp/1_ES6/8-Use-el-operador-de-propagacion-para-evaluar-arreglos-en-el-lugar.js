...
Tuvimos que usar Math.max.apply(null, arr) porque Math.max(arr) regresa NaN.
...
En otras palabras, extiende la matriz. Sin embargo, el operador de propagación solo 
funciona en el lugar, como en un argumento de una función o en un literal de matriz.
