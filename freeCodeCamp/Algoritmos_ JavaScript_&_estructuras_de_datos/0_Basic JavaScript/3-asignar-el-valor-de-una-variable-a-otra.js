...
Lo anterior declara una myVarvariable sin valor, luego le asigna el valor 5. 
A continuación, se declara una variable nombrada myNumsin valor. 
Luego, el contenido de myVar(que es 5) se asigna a la variable myNum. 
